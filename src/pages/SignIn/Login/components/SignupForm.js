...
class SignupForm extends React.Component {
    ...
    render() {
        ...
        const green = {color:"#1FC36A"};
        const red = {color: "#d94f2b"};
                        ...
                        <form  ref={form}>
                            ...
                            <div className="passwordRules">
                                ...
                                <div className="passwordRules--ruleWrapper">
                                    {oneLowerCase ? <FaCheck style={green}/> : <FaTimes />} 
                                    {oneLowerCase ? <h5 style={green}>One lowercase character</h5> : <h5>One lowercase character</h5>} 
                                    {oneUpperCase ? <FaCheck style={green}/> : <FaTimes />} 
                                    {oneUpperCase ? <h5 style={green}>One uppercase character</h5> : <h5>One uppercase character</h5>} 
                                    {oneNumber ? <FaCheck style={green}/> : <FaTimes />} 
                                    {oneNumber ? <h5 style={green} className="number">One number</h5> : <h5 className="number">One number</h5>} 
                                    {eightDigits ? <FaCheck style={green}/> : <FaTimes />} 
                                    {eightDigits ? <h5 style={green}>8 characters minimum</h5> : <h5>8 characters minimum</h5>} 
                                </div>
                            </div>
                            {
                                userExists? <span style={red}>This Email has already been used!</span> : <span></span>
                            }
